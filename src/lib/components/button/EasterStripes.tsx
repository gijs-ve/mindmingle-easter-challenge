...
export const EasterStripes = ({
    ...
    while (
        _borderColor === firstColor ||
        _borderColor === secondColor ||
        _borderColor === middleColor
    ) {
                ...
                return (
                    <span
                        ...
                        className={classNames(
                            'flex h-1/5 min-w-full items-center justify-center',
                            {
                                'border-y-2': index === 2,
                                ...
                                'border-red-400':
                                    borderColor === 'red' && index === 2,
                                'border-orange-400':
                                    borderColor === 'orange' && index === 2,
                                'border-yellow-400':
                                    borderColor === 'yellow' && index === 2,
                                'border-green-400':
                                    borderColor === 'green' && index === 2,
                                'border-blue-400':
                                    borderColor === 'blue' && index === 2,
                                'border-purple-400':
                                    borderColor === 'purple' && index === 2,
                                'border-pink-400':
                                    borderColor === 'pink' && index === 2,
                                'border-rose-800':
                                    borderColor === 'heavyRed' && index === 2,
                                'border-cyan-400':
